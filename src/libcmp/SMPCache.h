...
private:
    ...
    void handleReadMiss(PAddr addr);
    void handleWriteMiss(PAddr addr);
    void handleCacheHit(PAddr addr);
...
protected:
    ...
    std::set<uint32_t> compulsoryAccessSet;
    std::deque<uint32_t> capacityMissCounter;
