...
public:
    ...
    virtual CacheLine *findLine2ReplaceWithoutReorder(Addr_t addr, bool ignoreLocked=false) = 0;
...
public:
    ...
    Line *findLine2ReplaceWithoutReorder(Addr_t addr, bool ignoreLocked=false);
};
